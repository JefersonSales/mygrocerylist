        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GroceryLists_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroceryLists_Users_IdUser",
                        column: x => x.IdUser,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroceryItem_CategoryId",
                table: "GroceryItems",
                column: "CategoryId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_GroceryItem_StoreId",
                table: "GroceryItems",
                column: "StoreId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroceryLists_CategoryId",
                table: "GroceryLists",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_GroceryLists_IdUser",
                table: "GroceryLists",
                column: "IdUser");
        }
